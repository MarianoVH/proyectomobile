<template>
    <div class="fondo " >
      ...
      <v-card flat width="90vw" class="man">
        <v-layout row wrap class="borders">
          ...
          <v-flex xs12 >
              ...
              <h2 class="infomatch font-weight-light">Teams Info!</h2>
          </v-flex>
        </v-layout>
      </v-card>  
      ...
      <v-card flat width="90%" class="wrapper" >
      <v-layout row wrap>
        <v-flex> 
        ...
        <v-flex xs12> 
          <v-card flat width="90%" class="man" > 
                <v-layout row wrap  >
                  <v-flex xs12 sm12  >
                    <v-card>
                      ...
                      <div >
                        ...
                        <v-list two-line subheader v-for="team in teamList" :key="team.id"> 
                          <v-list-tile> 
                            <v-list-tile-content>
                              <v-list-tile-title >{{ team.Elementary }}</v-list-tile-title>
                              <v-list-tile-sub-title>{{ team.Location }}</v-list-tile-sub-title>
                            </v-list-tile-content>
                            <v-list-tile-action>
                              <v-btn  icon flat @click="infoTeamDialog(team)" ><v-icon color="green lighten-1">info</v-icon></v-btn>
                            </v-list-tile-action>
                 ...
                 <v-dialog v-model="dialogdisplay"  max-width="90vw"  height="90vh">
              ...
              <v-layout row wrap class="display">
                <v-flex xs12 >
                  <v-card-title class="justify-center ma-0 pa-0">
                    <h2 class="titleschool mt-2"> {{dialoginfo.Elementary}}  </h2> 
    
                  </v-card-title>   
                  <v-card-text class="pa-0" >
                    
                    <div class="imgcenter">
                      <img  :src=" dialoginfo.logo " alt="" width="200px" height="200px"> 
                    </div>

                    <p class="informacionteams">Location:</p> 
                     <p class="informacionvue">{{dialoginfo.Location}}</p>
                     <p class="informacionteams">Team:</p> 
                     <p class="informacionvue">{{dialoginfo.team}}</p>
                  </v-card-text>
                </v-flex>
              </v-layout>
            </v-card>
            ...
            <v-card flat width="90%" class="man colorcard" >
              <v-layout row wrap class="display">
                ...
                <v-flex xs12 text-xs-center>
                  ...
                  <v-list-tile-action>
                    <v-btn class="buttonclose" @click="closedialog" icon flat><v-icon color="red lighten-1">highlight_off</v-icon></v-btn>
                  </v-list-tile-action>
                </v-flex>
              </v-layout>
            </v-card>
  ...
  export default { 
    data (){
      ...
      /* aca  */
        ...
        arrayAux: {},
        teamList:[
            {team:'Eugene Liller - Jerrold Junk - Gregg Gavin - Walter Witman - Foster Franck - David Dalke - Geoffrey Goudy - Jeramy Jhonson - Santo Sheeran - Tomas Tope - Ray Raye  ',logo: require('../assets/logo.png'),Elementary: 'AJ Katzenmaier', id: 1, Location:'24 W. Walton St., Chicago ', map:'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11878.628774263563!2d-87.629069!3d41.900229!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x15e198c063fc787c!2sAJ+Katzenmaier+Elementary!5e0!3m2!1ses-419!2sar!4v1559451753593!5m2!1ses-419!2sar'},
            {team:'Daren Cosgrove - Christian Hacker  - Colin Deines  - Robbie Sandor  - Deshawn Streett  - Aurelio Killgore  - Trenton Moffett  - Jamaal Castrejon  - Ike Natale  - Mikel Crowl  - Matthew Simo ',logo: require('../assets/logo2.png'),Elementary: 'Greenbay', id: 2, Location:'1734 N. Orleans St., Chicago ', img:'../assets/howard.png', map:'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2039.6670880608135!2d-87.63649016805219!3d41.91332968182832!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb351205fae50c6f3!2sGreenbay+Elementary!5e0!3m2!1ses-419!2sar!4v1559451428207!5m2!1ses-419!2sar'},
            {team:'Leonardo Buckwalter - Lazaro Laubscher  - Lanny Quintana  Lenny Halterman - Gerard Scotto - Rhett Sabol - Oswaldo Eickhoff - Bobby Shi - Fermin Magness - Teddy Garside - Enoch Holst - Forest Munsey ',logo: require('../assets/howard.png'),Elementary: 'Howard A Yeager', id: 3, Location:'2245 N. Southport Ave., Chicago ', map:'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11874.342654033595!2d-87.662926!3d41.923265!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fd2e37f9b8d2d%3A0x62ad8b907dd755d6!2s2245+N+Southport+Ave%2C+Chicago%2C+IL+60614%2C+EE.+UU.!5e0!3m2!1ses-419!2sar!4v1559451938954!5m2!1ses-419!2sar'},
            {team:'Buford Laramore - Billie Cesar - Edmond Fennessey - Bryce Hawke - Toney Lambrecht - Moshe Haislip - Xavier Walkowiak - Paris Olaughlin - Carey Strate  Omar Whiteman -  Alonso Burford  ',logo: require('../assets/logo4.png'),Elementary: 'Marjorie P Hart', id: 4, Location:'2625 N. Orchard St., Chicago ', map:'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11873.159334915188!2d-87.645973!3d41.929623!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xdbff5d5dfcfcfa35!2sMarjorie+P+Hart+Elementary!5e0!3m2!1ses-419!2sar!4v1559451979296!5m2!1ses-419!2sar'},
            {team:'Walton Menke - Earnest Savedra - Marquis Kells - Virgil Nantz  - Alfonso Tyson  Zachary Tilford -Douglass Quellette -Bernardo Gephart -Blair Mcbee -Del Crandell - Kory Beer -Dudley Vanbrunt  ',logo: require('../assets/logo5.png'),Elementary: 'North Elementary', id: 5, Location:'1409 N. Ogden Ave., Chicago', map:'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11877.351102508312!2d-87.646188!3d41.907097!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fd33af0e6ccc3%3A0x26c81c1d557667da!2s1409+N+Ogden+Ave%2C+Chicago%2C+IL+60610%2C+EE.+UU.!5e0!3m2!1ses-419!2sar!4v1559451818299!5m2!1ses-419!2sar'},
            {team:'Jae Morgenstern - Russell Chachere - Edmund Fulk  - Joel Fiorini  - Arlen Wendler  - Johnnie Hamill  - Carlos Tanguay  - Caleb Montanez  - Perry Farnum  - Mark Dehne ',logo: require('../assets/logo3.png'),Elementary: 'South Elementary' , id: 6, Location:'2101 N. Fremont St., Chicago', map:'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11874.991761014922!2d-87.651367!3d41.919777!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fd3196fb41dc7%3A0x970be7f7d6336df5!2s2101+N+Fremont+St%2C+Chicago%2C+IL+60614%2C+EE.+UU.!5e0!3m2!1ses-419!2sar!4v1559451884475!5m2!1ses-419!2sar'}
        ],
        gamesList:[
            {
                U1:
